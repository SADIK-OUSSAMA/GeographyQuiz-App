...
public class Quiz8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference docRef = db.collection("geoQuiz").document("Quiz8");
        ...
        docRef.get().addOnSuccessListener(documentSnapshot -> {
            if (documentSnapshot.exists()) {
                ...
                Toast.makeText(this, "Données non trouvées pour Quiz8", Toast.LENGTH_SHORT).show();
            }
        ...
        bNext.setOnClickListener(v -> {
            if (rg.getCheckedRadioButtonId() == -1) {
                ...
                Intent intent = new Intent(Quiz8.this, Quiz9.class); // or ResultActivity if it's last quiz
