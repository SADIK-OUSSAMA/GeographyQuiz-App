...
public class Quiz10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference docRef = db.collection("geoQuiz").document("Quiz10");
        ...
        docRef.get().addOnSuccessListener(documentSnapshot -> {
            if (documentSnapshot.exists()) {
                ...
                Toast.makeText(this, "Données non trouvées pour Quiz10", Toast.LENGTH_SHORT).show();
            }
        ...
        bNext.setOnClickListener(v -> {
            if (rg.getCheckedRadioButtonId() == -1) {
                ...
                Intent intent = new Intent(Quiz10.this, ResultActivity.class); // or ResultActivity if it's last quiz
