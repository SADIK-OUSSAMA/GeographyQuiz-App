...
public class Quiz3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference docRef = db.collection("geoQuiz").document("Quiz3");
        ...
        docRef.get().addOnSuccessListener(documentSnapshot -> {
            if (documentSnapshot.exists()) {
                ...
                Toast.makeText(this, "Données non trouvées pour Quiz3", Toast.LENGTH_SHORT).show();
            }
        ...
        bNext.setOnClickListener(v -> {
            if (rg.getCheckedRadioButtonId() == -1) {
                ...
                Intent intent = new Intent(Quiz3.this, Quiz4.class); // or ResultActivity if it's last quiz
