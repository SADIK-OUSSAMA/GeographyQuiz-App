...
public class Quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference docRef = db.collection("geoQuiz").document("Quiz4");
        ...
        docRef.get().addOnSuccessListener(documentSnapshot -> {
            if (documentSnapshot.exists()) {
                ...
                Toast.makeText(this, "Données non trouvées pour Quiz 4", Toast.LENGTH_SHORT).show();
            }
        ...
        bNext.setOnClickListener(v -> {
            if (rg.getCheckedRadioButtonId() == -1) {
                ...
                Intent intent = new Intent(Quiz4.this, Quiz5.class); // or ResultActivity if it's last quiz
